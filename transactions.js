...
(function(root,factory){var api=factory();if(typeof module!=="undefined"&&module.exports)module.exports=api;root.Transactions=api.Transactions})(typeof globalThis!=="undefined"?globalThis:this,function(){
  ...
  function base(input,type){input=input||{};var date=input.jDate||input.date||input.issueDate||input.dueDate;required(date,'jDate');return Object.assign({id:uid(type+'-'),type:type,createdAt:new Date().toISOString()},input,{jDate:date,amount:amount(input.amount)})}
