...
test('contract allocation uses the financial domain tier rule for settlement and principal reduction',()=>{
  ...
  e.addReceipt({id:'R1',customerId:'C1',jDate:'1405/07/16',amount:104.5,status:'وصول شده'});
  const rows=e.allocateReceipt('R1','1405/07/16',{dayBasis:30,tiers:[{maxDays:30,rate:0,active:true},{maxDays:60,rate:0.06,active:true}]});
