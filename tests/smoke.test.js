...
test('index is a thin modular entry point', () => {
  ...
  for (const script of ['domain.js','business-modules.js','data.js','inventory.js','transactions.js','reports.js','ui-phase05.js','ui-patch.js','app.js']) {
...
test('application modules referenced by the entry point exist', () => {
  const html = fs.readFileSync('index.html', 'utf8');
  for (const src of ['domain.js','business-modules.js','data.js','inventory.js','transactions.js','reports.js','ui-phase05.js','ui-patch.js','app.js']) {
